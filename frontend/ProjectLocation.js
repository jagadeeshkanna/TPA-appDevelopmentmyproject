...
function ProjectLocation() {
  return (
     <div>
        ...
        <center>
        <Link to ="/Waste"><center><h1 className='hi'><Button variant="contained"  className="submitButton" sx={{ bgcolor : "blue" } }>Click here to search place!</Button></h1></center></Link>
   ...
   <h2>Here are some of the places</h2>
