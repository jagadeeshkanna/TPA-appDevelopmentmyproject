...
function Home() {
  ...
  return (
    ...
    <Link to ='/ProjectLocation'><LocalOfferIcon sx={{ fontSize: 35,color:"black"  }} className='k'></LocalOfferIcon></Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <Link to ='/Feedback'><RecentActorsIcon sx={{ fontSize: 35,color:"black"  }} className='k'></RecentActorsIcon></Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
